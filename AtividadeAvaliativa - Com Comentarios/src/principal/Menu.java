 ...
 * o que significa que n�o pode ser instanciada diretamente, 
...
* padrao (System.in).*/
	...
	* do tipo int, que sera usada para armazenar a opçao escolhida pelo 
	* usuario.
	* */
	protected int opcao;
	...
	* Esse metodo representa o menu principal do programa.*/
	...
	/*protected abstract void listarOpcoes();`: Declara um m�todo abstrato 
	 * chamado listarOpcoes(), que sera implementado nas classes filhas. 
	 * Esse metodo  responsavel por listar as opçoes disponiveis no menu.*/
